...
export default function HomePage() {
  ...
  const connectWallet = async () => {
    // In production, this would use OnChainKit
    setIsConnected(true)
  ...
  const handleMintSuccess = (newProject: any) => {
    setUserNFTs((prev) => [{ ...newProject, verified: true }, ...prev])
  }

  const portfolioUrl = `${typeof window !== "undefined" ? window.location.origin : ""}/portfolio/${walletAddress}`
      ...
      <main className="container mx-auto px-6 py-12">
        {!isConnected ? (
          ...
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <div className="space-y-6">
              <h1 className="text-5xl font-bold text-balance leading-tight">
                Showcase Your Projects as <span className="text-accent">Verifiable NFTs</span>
              </h1>
              <p className="text-xl text-muted-foreground text-balance max-w-2xl mx-auto leading-relaxed">
                Transform your academic and personal projects into blockchain-verified credentials. Create an immutable
                portfolio that employers and educators can trust.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              <Card className="text-center">
                ...
                <CardContent>
                  <CardDescription>Sign in with your crypto wallet using MetaMask or WalletConnect</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  <CardDescription>Upload project details and mint them as NFTs on the blockchain</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Share Portfolio</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription>Get a shareable link to your verified portfolio for employers</CardDescription>
                </CardContent>
              </Card>
            </div>

            <Button size="lg" onClick={connectWallet} className="gap-2 text-lg px-8 py-6">
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-foreground">Your NFT Portfolio</h1>
                <p className="text-muted-foreground mt-2">Manage and showcase your blockchain-verified projects</p>
              </div>
              <div className="flex items-center gap-3">
            ...
            {userNFTs.length > 0 && (
              <Card className="bg-gradient-to-r from-accent/5 to-primary/5 border-accent/20">
                <CardHeader>
                  ...
                  <CardDescription>
                    Share this link with employers and educators to showcase your verified projects
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between p-3 bg-background/50 rounded-lg border">
                    <code className="text-sm text-muted-foreground font-mono">
                      /portfolio/{walletAddress.slice(0, 6)}...{walletAddress.slice(-4)}
                    </code>
                ...
                <Card key={nft.id} className="overflow-hidden">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 pt-2">
                      ...
                      <VerificationDialog project={nft} walletAddress={walletAddress} />
